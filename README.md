...
**1) BASA 어쏘(Associate) 트랙:** `기초적인 분석 역량`만 있기에 `역량 고도화 스터디와 프로젝트를 통한 현실 데이터분석을 경험`하여 역량을 향상
...
**2) BASA 프로(Pro) 트랙:** 충분한 데이터분석 역량이 있기에 `본격적으로 데이터 애널리스트/싸이언티스트 역량 입증을 위한 브랜딩 집중` 
